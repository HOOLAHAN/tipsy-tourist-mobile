export default {
  expo: {
    ...
    android: { package: 'com.tipsytourist.mobile', config: { googleMaps: { apiKey: process.env.EXPO_PUBLIC_GOOGLE_MAPS_API_KEY } }, adaptiveIcon: { backgroundColor: '#fffaf1', foregroundImage: './assets/android-icon-foreground.png', backgroundImage: './assets/android-icon-background.png', monochromeImage: './assets/android-icon-monochrome.png' }, permissions: ['ACCESS_COARSE_LOCATION', 'ACCESS_FINE_LOCATION'] },
    plugins: [
