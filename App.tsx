...
const styles = StyleSheet.create({
  ...
  dragZone: { minHeight: 34, alignItems: 'center', justifyContent: 'center', paddingTop: 7 },
  ...
  bottomModalSafe: { flex: 0, justifyContent: 'flex-end' },
  bottomModalPanel: { maxHeight: '88%', borderBottomLeftRadius: 0, borderBottomRightRadius: 0, borderTopLeftRadius: 30, borderTopRightRadius: 30, borderBottomWidth: 0 },
  modalDismiss: { flex: 1 },
